...
public class Main {
    ...
    //    static {
//        System.loadLibrary("Food.dll"); // Provide the full path to the DLL
//    }
...
//        }
        ...
        for (; msg.count < N_MSGS; ++msg.count) {
            System.err.println(msg.count);
            while ((ret = mdw.write(msg, handle)) == RETCODE_TIMEOUT.value) {
            }
            System.out.println(ret);
            System.out.println(RETCODE_TIMEOUT.value);
        ...
        System.out.println(matched.value.current_count);
