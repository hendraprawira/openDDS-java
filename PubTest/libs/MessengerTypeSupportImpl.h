...
#ifndef OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_HO8GUR
#define OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_HO8GUR

#include <dds/Version.h>
#if !OPENDDS_VERSION_EXACTLY(3, 25, 0)
...
struct Foo_Export Message_OpenDDS_KeyLessThan {
...
namespace Messenger {
class Foo_Export MessageTypeSupportImpl
...
template <>
Foo_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::Messenger::Message,  ::Messenger::Message>(DDS::DynamicType_ptr type, const  ::Messenger::Message& value);

template <>
Foo_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::Messenger::Message,  ::Messenger::Message>(DDS::DynamicType_ptr type,  ::Messenger::Message& value);

template <>
Foo_Export const  ::Messenger::Message* get_dynamic_data_adapter_value< ::Messenger::Message,  ::Messenger::Message>(DDS::DynamicData_ptr dd);
...
#endif /* OPENDDS_IDL_GENERATED_MESSENGERTYPESUPPORTIMPL_H_HO8GUR */
