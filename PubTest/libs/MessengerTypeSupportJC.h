...
class Foo_Export Messenger_MessageTypeSupportJavaPeer
...
public:
  ...
  DDS::ReturnCode_t encode_to_string (const Messenger::Message& sample, CORBA::String_out encoded, OpenDDS::DCPS::RepresentationFormat_ptr format);

  DDS::ReturnCode_t encode_to_bytes (const Messenger::Message& sample, DDS::OctetSeq_out encoded, OpenDDS::DCPS::RepresentationFormat_ptr format);

  DDS::ReturnCode_t decode_from_string (const char * encoded, Messenger::Message_out sample, OpenDDS::DCPS::RepresentationFormat_ptr format);

  DDS::ReturnCode_t decode_from_bytes (const DDS::OctetSeq& encoded, Messenger::Message_out sample, OpenDDS::DCPS::RepresentationFormat_ptr format);
...
class Foo_Export Messenger_MessageDataWriterJavaPeer
...
class Foo_Export Messenger_MessageDataReaderJavaPeer
