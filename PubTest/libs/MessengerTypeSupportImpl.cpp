/* Generated by /home/prawirah/OpenDDS-3.25/bin/opendds_idl version 3.25.0 (ACE version 6.5.20) running on input file Messenger.idl */
...
template<> const XTypes::TypeIdentifier& getMinimalTypeIdentifier<Messenger_Message_xtag>()
{
  ...
  if (ti.kind() == XTypes::TK_NONE) {
    ti = XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(24, 156, 99, 231, 208, 114, 195, 85, 71, 116, 126, 140, 223, 143));
  }
  return ti;
}
...
void vwrite(OpenDDS::DCPS::ValueWriter& value_writer, const  ::Messenger::Message& value)
{
  ...
  value_writer.begin_struct_member(XTypes::MemberDescriptorImpl("from", false));
  value_writer.write_string(value.from);
  value_writer.end_struct_member();
  value_writer.begin_struct_member(XTypes::MemberDescriptorImpl("subject", false));
  value_writer.write_string(value.subject);
  value_writer.end_struct_member();
  value_writer.begin_struct_member(XTypes::MemberDescriptorImpl("subject_id", true));
  ...
  value_writer.end_struct_member();
  value_writer.begin_struct_member(XTypes::MemberDescriptorImpl("count", false));
...
{
  const unsigned char to_bytes[] = { 99, 0, 0, 0, 241, 81, 2, 0, 1, 0, 0, 0, 0, 0, 0, 0, 83, 0, 0, 0, 5, 0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 0, 1, 0, 112, 0, 217, 138, 7, 248, 12, 0, 0, 0, 1, 0, 0, 0, 1, 0, 112, 0, 181, 227, 55, 78, 11, 0, 0, 0, 2, 0, 0, 0, 33, 0, 4, 255, 171, 161, 209, 0, 12, 0, 0, 0, 3, 0, 0, 0, 1, 0, 112, 0, 28, 178, 81, 236, 11, 0, 0, 0, 4, 0, 0, 0, 1, 0, 7, 226, 148, 42, 4  };
...
{
  XTypes::TypeMap tm;
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(24, 156, 99, 231, 208, 114, 195, 85, 71, 116, 126, 140, 223, 143))] = minimal_to0();
  return tm;
}
